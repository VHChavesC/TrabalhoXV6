...
_FRRSanity: formato do arquivo elf32-i386
...
int main(){
  ...
  14:	e8 19 04 00 00       	call   432 <getpid>
  19:	83 ec 04             	sub    $0x4,%esp
  1c:	50                   	push   %eax
  1d:	68 68 08 00 00       	push   $0x868
  22:	6a 01                	push   $0x1
  24:	e8 e7 04 00 00       	call   510 <printf>

	PID=fork();
  29:	e8 7c 03 00 00       	call   3aa <fork>
  ...
  33:	89 c6                	mov    %eax,%esi
	if(PID==0)
  35:	0f 84 fb 00 00 00    	je     136 <main+0x136>
int main(){
  3b:	31 c0                	xor    %eax,%eax
  3d:	eb 08                	jmp    47 <main+0x47>
  3f:	90                   	nop
		printf(1, "Child %d criada \n", getpid());

	for(int i=0; i<9;i++){
  40:	83 fb 09             	cmp    $0x9,%ebx
  43:	89 d8                	mov    %ebx,%eax
  45:	74 49                	je     90 <main+0x90>
		if(PID==0){
  47:	85 f6                	test   %esi,%esi
  49:	8d 58 01             	lea    0x1(%eax),%ebx
  4c:	75 f2                	jne    40 <main+0x40>
			PID=fork();
  4e:	e8 57 03 00 00       	call   3aa <fork>
			if(PID==0){
  ...
  57:	75 e7                	jne    40 <main+0x40>
				printf(1, "Child %d criada \n", getpid());
  59:	e8 d4 03 00 00       	call   432 <getpid>
  5e:	83 ec 04             	sub    $0x4,%esp
  61:	50                   	push   %eax
  62:	68 68 08 00 00       	push   $0x868
  67:	6a 01                	push   $0x1
  69:	e8 a2 04 00 00       	call   510 <printf>
	for(int i=0; i<9;i++){
  6e:	83 c4 10             	add    $0x10,%esp
  71:	83 fb 09             	cmp    $0x9,%ebx
  74:	74 1a                	je     90 <main+0x90>
			PID=fork();
  76:	e8 2f 03 00 00       	call   3aa <fork>
  ...
  80:	89 c6                	mov    %eax,%esi
			if(PID==0){
  82:	75 bc                	jne    40 <main+0x40>
  84:	eb d3                	jmp    59 <main+0x59>
...
int main(){
  ...
  9b:	e8 92 03 00 00       	call   432 <getpid>
  a0:	53                   	push   %ebx
  a1:	50                   	push   %eax
  a2:	68 7a 08 00 00       	push   $0x87a
  a7:	6a 01                	push   $0x1
  a9:	e8 62 04 00 00       	call   510 <printf>
	for(int i=0;i<100;i++){
  ae:	83 c4 10             	add    $0x10,%esp
  b1:	83 fb 64             	cmp    $0x64,%ebx
  b4:	75 e2                	jne    98 <main+0x98>

	}


	int endTime=uptime();
  b6:	e8 8f 03 00 00       	call   44a <uptime>
  bb:	89 c3                	mov    %eax,%ebx


	int runtime=runt();
  bd:	e8 90 03 00 00       	call   452 <runt>
  c2:	89 c6                	mov    %eax,%esi

	wait();
  c4:	e8 f1 02 00 00       	call   3ba <wait>
	sleep(30);
  c9:	83 ec 0c             	sub    $0xc,%esp
  cc:	6a 1e                	push   $0x1e
  ce:	e8 6f 03 00 00       	call   442 <sleep>
	printf(1,"PID %d begin %d end time %d\n", getpid(), beginT(),endTime);
  d3:	e8 82 03 00 00       	call   45a <beginT>
  d8:	89 c7                	mov    %eax,%edi
  da:	e8 53 03 00 00       	call   432 <getpid>
  ...
  e3:	89 df                	mov    %ebx,%edi
	printf(1,"PID %d begin %d end time %d\n", getpid(), beginT(),endTime);
  e5:	50                   	push   %eax
  e6:	68 97 08 00 00       	push   $0x897
  eb:	6a 01                	push   $0x1
  ed:	e8 1e 04 00 00       	call   510 <printf>
	printf(1, "Child %d ends at %d\n", getpid(),endTime-beginT());
  f2:	83 c4 20             	add    $0x20,%esp
  f5:	e8 60 03 00 00       	call   45a <beginT>
  fa:	29 c7                	sub    %eax,%edi
  fc:	e8 31 03 00 00       	call   432 <getpid>
 101:	57                   	push   %edi
 102:	50                   	push   %eax
 103:	68 b4 08 00 00       	push   $0x8b4
 108:	6a 01                	push   $0x1
 10a:	e8 01 04 00 00       	call   510 <printf>
	printf(1,"Process %d Runtime: %d , Waiting time: %d\n", getpid(), runtime,endTime-beginT()-runtime);
 10f:	e8 46 03 00 00       	call   45a <beginT>
 114:	29 c3                	sub    %eax,%ebx
 116:	29 f3                	sub    %esi,%ebx
 118:	e8 15 03 00 00       	call   432 <getpid>
 11d:	89 1c 24             	mov    %ebx,(%esp)
 120:	56                   	push   %esi
 121:	50                   	push   %eax
 122:	68 cc 08 00 00       	push   $0x8cc
 127:	6a 01                	push   $0x1
 ...
 131:	e8 7c 02 00 00       	call   3b2 <exit>
		printf(1, "Child %d criada \n", getpid());
 136:	e8 f7 02 00 00       	call   432 <getpid>
 13b:	52                   	push   %edx
 13c:	50                   	push   %eax
 13d:	68 68 08 00 00       	push   $0x868
 142:	6a 01                	push   $0x1
 144:	e8 c7 03 00 00       	call   510 <printf>
 149:	83 c4 10             	add    $0x10,%esp
 14c:	e9 ea fe ff ff       	jmp    3b <main+0x3b>
 ...
 479:	85 d2                	test   %edx,%edx
{
 ...
 4a7:	f7 f1                	div    %ecx
 4a9:	0f b6 92 00 09 00 00 	movzbl 0x900(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	e9 8f fe ff ff       	jmp    558 <printf+0x48>
          s = "(null)";
 6c9:	bb f8 08 00 00       	mov    $0x8f8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 71d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71f:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 724:	5b                   	pop    %ebx
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 c4 0b 00 00       	mov    %eax,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 47                	jae    808 <malloc+0x98>
    ...
    if(p == freep)
 7c1:	39 05 c4 0b 00 00    	cmp    %eax,0xbc4
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
  return freep;
 7eb:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 817:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 837:	0b 00 00 
 83a:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 841:	0b 00 00 
    base.s.size = 0;
 844:	b8 c8 0b 00 00       	mov    $0xbc8,%eax
 849:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 850:	00 00 00 
